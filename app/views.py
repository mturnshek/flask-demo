...
def index():
    ...
    if request.method == 'POST' and form.validate():
        ...
        # create a new post
        post = Post(body = form.body.data, author_username = g.user.username)
...
def register():
    ...
    if request.method == 'POST' and form.validate():
        ...
        user = User(
            ...
            password = form.password.data, # the password isn't encrypted!
        )
...
def search_twitter():
    ...
    tweets = None
    if request.method == 'POST' and form.validate():
        tweets = twit.collect_tweets_from_query(
            form.search_tag.data,
            num_tweets
        )
